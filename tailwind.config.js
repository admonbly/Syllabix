  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        card:         '0 2px 8px rgba(0,0,0,0.05), 0 8px 24px rgba(0,0,0,0.05)',
        'card-hover': '0 8px 16px rgba(0,0,0,0.08), 0 20px 40px rgba(0,0,0,0.10)',
        accent:       '0 4px 20px rgba(230,126,34,0.30)',
        'accent-lg':  '0 8px 32px rgba(230,126,34,0.40)',
        primary:      '0 4px 20px rgba(26,35,126,0.30)',
        glow:         '0 0 40px rgba(230,126,34,0.20)',
