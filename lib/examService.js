...
export const EXAM_CONFIG = {
  TRAINING: {
    QUESTIONS_COUNT: 10, // questions par session d'entraînement / défi
    SESSION_SIZE: 10,
    DURATION: 900,       // 15 min
    SHOW_FEEDBACK: true,
    SAVE_RESULTS: false, // l'entraînement classique ne persiste rien ; le badge
                         // d'apprentissage est posé par /api/training/badge (Lot A)
    ISSUE_CERTIFICATE: false,
    BADGE_MIN_SCORE: 60, // seuil pour décrocher le badge d'apprentissage
  },
  EVALUATION: {
    QUESTIONS_COUNT: 16,
