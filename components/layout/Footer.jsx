...
// Réseaux sociaux officiels Syllabix (icônes de marque)
const SOCIALS = [
  {
    label: 'LinkedIn',
  ...
  {
    label: 'Instagram',
    href: 'https://www.instagram.com/syllabix_/',
  ...
  {
    label: 'Facebook',
    href: 'https://www.facebook.com/profile.php?id=61591740914806',
            ...
            <div className="flex items-center gap-3">
              {SOCIALS.map(({ label, href, path }) => (
                <a
                  ...
                  aria-label={label}
                  title={label}
                  className="w-9 h-9 rounded-xl bg-white/10 hover:bg-accent text-white/60 hover:text-white flex items-center justify-center transition-colors"
                >
